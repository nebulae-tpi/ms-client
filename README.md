...
![Intro](docs/images/ms-client_intro.png "Intro")
# Table of Contents
  ...
  * [BackEnd](#backend)
    *  [client](#backend_client)
        * [Environment variables](#backend_client_env_vars)
        * [Event Sourcing](#backend_client_eventsourcing)
        * [CronJobs](#backend_client_cronjobs)
...
│   ├── client                     => Micro-BackEnd responsible for ...
...
Note: You may find the GraphQL schema [here](api/emi-gateway/graphql/client/schema.gql)
...
## client <a name="backend_client"></a>
...


### Environment variables <a name="backend_client_env_vars"></a>
...
```
#### Notes: 
  * ENV VARS for development are [here](backend/client/.env)
  * ENV VARS for production are [here](deployment/gke/deployment-client.yaml)

### Event Sourcing <a name="backend_client_eventsourcing"></a>
...
### CronJobs <a name="backend_client_cronjobs"></a>
...
### 1. clone this repo  
   ```git clone https://github.com/nebulae-tpi/ms-client.git```  
...
### 5. Compose FrontEnd
```
nebulae compose-ui development --shell-type=FUSE2_ANGULAR --shell-repo=https://github.com/nebulae-tpi/emi --frontend-id=emi --output-dir=/FULL_PATH_TO_REPO/ms-client/playground/emi  --setup-file=/FULL_PATH_TO_REPO/ms-client/etc/mfe-setup.json
```

### 6. Compose the API emi-gateway
```
nebulae compose-api development --api-type=NEBULAE_GATEWAY --api-repo=https://github.com/nebulae-tpi/emi-gateway --api-id=emi-gateway --output-dir=FULL_PATH_TO_REPO/ms-client/playground/emi-gateway  --setup-file=FULL_PATH_TO_REPO/ms-client/etc/mapi-setup.json
```
...
* set this key value to the **JWT_PUBLIC_KEY** atribute in the following files: *WORKING_FOLDER*/ms-client/backend/client/.env   *WORKING_FOLDER*/ms-client/playground/emi-gateway/.env  
